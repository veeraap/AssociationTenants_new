...
In this readme, you will find examples of JSON schemas representing pages with their associated components and nested structures. These schemas demonstrate how to represent the `Page` and `Container` classes described below using JSON format.
